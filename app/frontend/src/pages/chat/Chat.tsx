                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Chat with your Medical Practice Assitant</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Ask anything or try suggested prompts</h2>
